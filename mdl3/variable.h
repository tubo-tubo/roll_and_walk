...
dReal axis[2][2]={{0,0},{0,0}}; //{{left_front and right_rear legs's axis} , {right_front and left_rear legs's axis}}


//dReal posx[2] = {l_thigh + l_shin*cos(M_PI_4), -l_thigh - l_shin*cos(M_PI_4)};
//dReal posy[2] = {l_shin*sin(M_PI_4), l_shin*sin(M_PI_4)};


dReal axis_sus[4]={0,0,0,0};	//joint_suspentionの制御量[rad]

dReal axisc[4] = {M_PI_2,-M_PI_2,-M_PI_2,M_PI_2};
dReal axisk[4] = {M_PI_4,-M_PI_4,-M_PI_4,M_PI_4};
dReal axisa[4] = {M_PI_4, -M_PI_4, -M_PI_4, M_PI_4};

//dReal axisc[4] = {M_PI_2+axis[0][0],-M_PI_2-axis[1][0],-M_PI_2-axis[0][0],M_PI_2+axis[1][0]};
//dReal axisk[4] = {M_PI_4+axis[0][1],-M_PI_4-axis[1][1],-M_PI_4-axis[0][1],M_PI_4+axis[1][1]};
//dReal axisa[4] = {M_PI_4+axis[0][0]-axis[0][1], -M_PI_4-axis[1][0]+axis[1][1], -M_PI_4-axis[0][0]+axis[0][1], M_PI_4+axis[1][0]-axis[1][1]};

dReal slide = r_wheel;            //0に設定すると謎の振動をする

//dReal moving[2] = {0,0}; //{stride , swing_up};
...
//static float view_point[3] = {1.2,0,0.2}, view_direction[3] = {180,0,0};		//視点の位置(x,y,z)[m],視点の方向(x,y,z)[deg]
//static float view_point[3] = {0,0,39}, view_direction[3] = {0,90,0};
